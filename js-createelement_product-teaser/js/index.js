...
const newTeaserElement = document.createElement("article");
newTeaserElement.classList.add("product");
newTeaserElement.innerHTML = `
...
document.body.append(newTeaserElement);
